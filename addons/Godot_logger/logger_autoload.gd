...
func log_info(log_message: String, log_details: Dictionary = {}):
...
func log_debug(log_message: String, log_details: Dictionary = {}):
...
func log_warn(log_message: String, log_details: Dictionary = {}):
...
func log_error(log_message: String, log_details: Dictionary = {}):
...
func log_fatal(log_message: String, log_details: Dictionary = {}):
